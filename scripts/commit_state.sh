#!/usr/bin/env bash
# Commit data/jobs.db + data/jobs.json + data/resume_versions.json + docs/index.html
...
STATE_PATHS="data/jobs.db data/jobs.json data/resume_versions.json docs/index.html"
